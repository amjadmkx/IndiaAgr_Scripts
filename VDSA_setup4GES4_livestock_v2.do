...
local files: dir "`datadir'" files "gesc_livestock*.dta"
...
replace present_val = preent_val if preent_val!="" 
replace remarks = remarks_c if remarks_c!=""
drop sur_yr remarks_c preent_val
...
local datadir  D:/AMK/StataFiles/Data/IndiaVDSA_Data/IndiaVDSA_compile
local outdir  D:/AMK/StataFiles/Data/IndiaVDSA_Data/IndiaVDSA_out
save `outdir'/ges4_livestock.dta, replace


/*need to clean livestock types*/
